...
function insertActiConduite( $dbFlotte, $unWsdl, $login, $dateRef ) {
	$soapVehicules = soapGetVehicles( $unWsdl, $login, $dateRef );
	
//	print_r($soapVehicules);
...
//					new SoapClient("http://transics.tx-connect.com/IWSLead/Service.asmx?WSDL"),
					...
					calcLogin(),
					$lastDate ); // '2013-03-26T00:51:30+00:00'
